...
function OnClientUpdate(player)
	...
	local player_team = getteam(player)
		...
		local score = getscore(player)
			...
			say("** FLAG CAPTURE **    " ..tostring(name).. " captured a flag for " ..player_team, false)
			sendconsoletext(player, "                                                          ** SCORE **")
			sendconsoletext(player, "                                             You have: ("..score..") total captures")
			sendconsoletext(player, " ")
			sendconsoletext(player, " ")
			sendconsoletext(player, " ")
			sendconsoletext(player, " ")
