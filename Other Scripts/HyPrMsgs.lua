...
---------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------
-- On Player Join Messages
SDTM_1 = "Announcement: A New Feature has arrived on OWV 3"
SDTM_2 = "* Hyper-Space *"
SDTM_3 = "(1) Press your flashlight Button to activate Hyper-Jumping!"
SDTM_4 = "(2) Use them wisely, you only get 3 Hyper Jumps per life"
SDTM_5 = "(3) You can Hyper Jump in or out of a vehicle."
---------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------
-- Timed Messages
function SDTM(id,count)
	say(SDTM_7, false)
	say(SDTM_8, false)
	say(SDTM_9, false)
	say(SDTM_10, false)
...
SDTM_7 = "Announcement: A New Feature has arrived on OWV 3!"
SDTM_8 = "* Hyper-Space *"
SDTM_9 = "(1) Press your flashlight Button to activate Hyper-Jumping!"
SDTM_10 = "(2) Use them wisely, you only get 3 Hyper Jumps per life"
SDTM_11 = "(3) You can Hyper Jump in or out of a vehicle."
---------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------
...
-- INFORMATION:
-- 1000*60 = 1 minute, so 60*20 = twenty minutes. 60 is equal to one minute. *60*(times)(any value here) = x amount of minutes.
function OnNewGame(Mapname)
	main_message = registertimer(1000*60*15,"SDTM") -- 1000*60*20 = 20 minutes. 
end

function DelayMessage(id, count, player)
	if getplayer(player) then
		privateSay(player, SDTM_1, false)
		privateSay(player, SDTM_2, false)
		privateSay(player, SDTM_3, false)
		privateSay(player, SDTM_4, false)
		privateSay(player, SDTM_5, false)
	end
	return false
end

function OnPlayerJoin(player)
	registertimer(1000*40,"DelayMessage",player) -- Sends the joining player the Welcome Announcement after (40) seconds. (1000 = 1 second [in miliseconds] and *40 = [40 seconds])
end
