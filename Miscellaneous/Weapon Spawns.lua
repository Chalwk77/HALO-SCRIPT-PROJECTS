...
-- AmysRoom --
weapons[31] = "weapons\\pistol\\pistol"
weapons[32] = "weapons\\sniper rifle\\sniper rifle"
weapons[33] = "weapons\\plasma_cannon\\plasma_cannon"
weapons[34] = "weapons\\rocket launcher\\rocket launcher"
weapons[35] = "weapons\\plasma pistol\\plasma pistol"
weapons[36] = "weapons\\plasma rifle\\plasma rifle"
weapons[37] = "weapons\\assault rifle\\assault rifle"
weapons[38] = "weapons\\flamethrower\\flamethrower"
weapons[39] = "weapons\\needler\\mp_needler"
weapons[40] = "weapons\\shotgun\\shotgun"
-- StarLagoon --
weapons[41] = "weapons\\Crossbow\\Crossbow"

-- If your gamemode is set up so that you spawn with infinite grenades,
-- this script will respect that setting, and you will continue to spawn with infinite grenades regardless of the settings below (:
...
function GrenadeTable()
    ...
    plasmas = {
        ...
        --  [!] - Custom Maps -
        snowdrop = 4,
        dustbeta = 0, -- WARNING - KEEP ZERO! Dust Beta doesn't have Plasma Grenades. (Server will crash if this number is higher than 0)
        dioptase = 0,
        rankin2_multiplayer = 4,
        --      <map name> = <number>
        MAP_NAME_HERE = 0 -- Make sure the last entry in the table doesn't have a comma at the end.
            ...
            if MapIsListed == false then
                ...
                if (weapon[i] == 0) then
                    ...
                    elseif (mapname == "snowdrop") then
                        assign_weapon(spawn_object("weap", weapons[23], x, y, z), i)
                    ...
                    elseif (mapname == "dioptase") then
                        ...
                        weapon[i] = 1
                    elseif (mapname == "rankin2_multiplayer") then
                        assign_weapon(spawn_object("weap", weapons[1], x, y, z), i)
                        assign_weapon(spawn_object("weap", weapons[6], x, y, z), i)
                        weapon[i] = 1
                    elseif (mapname == "training_ground_zero") then
                        assign_weapon(spawn_object("weap", weapons[2], x, y, z), i) -- Sniper Rifle
                        assign_weapon(spawn_object("weap", weapons[1], x, y, z), i) -- Pistol
                        weapon[i] = 1
                    end
