...
-- objectidtoplayer (For Wizards NO LEAD verison of Phasor) {line 2936 or thereabouts}
-- Prefix Globals --
...
---------------------------------------------------------------------
-- FOR WIZARDS NO LEAD VERSION OF PHASOR
--[[
...
function DefaultSvTimer(id, count, filename, time)
    ...
    respond("                         Chalwk's Realm | Classic Snipers (original)")
    respond("                      ->-<->-<->-<->-<->-<->-<->-<->-<->-<->-<->-<->-<->-")
    respond("")
