...
function math.random(low, high)
    ...
    RANDOM_NUMBER(low, high) RANDOM_NUMBER(low, high) RANDOM_NUMBER(low, high) RANDOM_NUMBER(low, high) RANDOM_NUMBER(low, high)
    RANDOM_NUMBER(high, low) RANDOM_NUMBER(high, low) RANDOM_NUMBER(high, low) RANDOM_NUMBER(high, low) RANDOM_NUMBER(high, low)
