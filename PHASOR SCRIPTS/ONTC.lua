...
-- Settings
starting_primary_ammo = 0
starting_secondary_ammo = 0
reset_ammo = true -- reset ammo count on spawn?
running_speed = 1.25
message_time = 3 -- in seconds. Time which bullets count appears for
ammo_for_kill = 3
...
--registertimer(500, "stats_timer", player)
ammo[player] = {}
