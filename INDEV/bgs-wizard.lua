...
local function GameSettings()
    ...
    settings = {
        mod = {
            ...
            ["Infinity Ammo"] = {
                enabled = true,
                server_override = true, -- If this is enabled, all players will have Infinity (perma-ammo) by default (the /infammo command cannot be used)
            ...
            ["Respawn Time"] = {
                ...
                maps = {
                    ...
                    ["wizard"] = { 3.0, 2.5, 2.5, 2.5, 2.5, 2.5, 2.5, 2.5, 2.5 },
