---------------------------------------------------------------------
-- Default settings will make a game last 1 hour & 30 minutes.
-- Min safe zone size: 49.47
-- Max safe zone size: 4700
-- Reduction rate: 60 seconds
-- Shrink amount: 50 world units
---------------------------------------------------------------------
