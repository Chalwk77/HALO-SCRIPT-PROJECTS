        ...
        crates = {
            ['eqip'] = { -- do not touch 'eqip'!
                ...
                ['powerups\\full-spectrum vision'] = {
                    ...
                    { -69.333, 10.547, -2.050, 35 },
                    { -72.210, 9.798, 0.350, 40 },
                    { -58.108, 13.580, 0.350, 45 },
                    { 59.457, 13.203, -4.350, 30 },
                    { 58.105, 13.570, 0.350, 35 },
                    { 72.206, 9.783, 0.350, 40 },
                    { 68.969, 10.660, -2.050, 45 },
                    { 6.339, 3.624, 1.350, 30 },
                    { -6.241, 3.612, 1.350, 35 },
                    { -9.388, 16.037, 3.650, 40 },
                    { 9.226, 15.926, 3.650, 45 },
                    { -0.011, 46.374, 0.605, 30 },
                    { 42.599, 39.585, -5.609, 35 },
                    { -36.029, 52.862, -6.300, 40 },
                    { -48.080, 32.325, -6.300, 45 },
                    { -17.633, 30.546, 5.850, 30 },
                    { 18.006, 31.111, 5.850, 35 },
                    { 5.664, 10.089, 5.850, 40 },
                    { -5.950, 10.213, 5.850, 45 },
                }
            }
        },
