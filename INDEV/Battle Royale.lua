...
function setupSpawns()
    ...
    spawn_coordinates = { 
        ...
        ["prisoner"] = {
            [1] = {coordinates_input, 0.5, 1.5},
            [2] = {coordinates_input, 0.5, 1.5},
            [3] = {coordinates_input, 0.5, 1.5},
            [4] = {coordinates_input, 0.5, 1.5},
            [5] = {coordinates_input, 0.5, 1.5},
            [6] = {coordinates_input, 0.5, 1.5},
            [7] = {coordinates_input, 0.5, 1.5},
            [8] = {coordinates_input, 0.5, 1.5},
            [9] = {coordinates_input, 0.5, 1.5},
            [10] = {coordinates_input, 0.5, 1.5},
            [11] = {coordinates_input, 0.5, 1.5},
            [12] = {coordinates_input, 0.5, 1.5},
            [13] = {coordinates_input, 0.5, 1.5},
            [14] = {coordinates_input, 0.5, 1.5},
            [15] = {coordinates_input, 0.5, 1.5},
            [16] = {coordinates_input, 0.5, 1.5},
        },
        ["wizard"] = {
            [1] = {coordinates_input, 0.5, 1.5},
            [2] = {coordinates_input, 0.5, 1.5},
