...
function setupSpawns()
    ...
    spawn_coordinates = { 
        ...
        ["carousel"] = {
            [1] = {-5.744, -3.427, -2.683, 0.5, 3},
            [2] = {-3.665, -5.637, -2.709, 0.5, 3},
            [3] = {3.404, -5.899, -2.709, 0.5, 3},
            [4] = {5.613, -3.612, -2.694, 0.5, 3},
            [5] = {5.809, 3.603, -2.729, 0.5, 3},
            [6] = {3.616, 5.839, -2.738, 0.5, 3},
            [7] = {-3.570, 5.878, -2.736, 0.5, 3},
            [8] = {-5.711, 3.648, -2.719, 0.5, 3},
            [9] = {-9.828, -9.998, -0.855, 0.5, 1.5},
            [10] = {-14.048, 0.008, -0.855, 0.5, 1.5},
            [11] = {9.717, 9.762, -0.855, 0.5, 1.5},
            [12] = {13.811, -0.175, -0.855, 0.5, 1.5},
            [13] = {7.495, -7.560, -0.855, 0.5, 1.5},
            [14] = {-7.419, 7.481, -0.855, 0.5, 1.5},
            [15] = {-0.016, 10.579, -0.855, 0.5, 1.5},
            [16] = {0.013, -10.802, -0.855, 0.5, 1.5},
        },
        ["ratrace"] = {
        ...
        ["beavercreek"] = {
            ...
            [12] = {24.873, 13.704, -1.355, 0.5, 1.5},
            [13] = {21.987, 13.837, -1.355, 0.5, 1.5},
            [14] = {24.507, 10.438, -1.354, 0.5, 1.5},
            [15] = {3.052, 13.687, -1.355, 0.5, 1.5},
            [16] = {5.764, 17.051, -0.154, 0.5, 1.5},
        },
        ["dangercanyon"] = {
        ...
        ["putput"] = {
            [1] = {33.093, -10.074, 1.303, 0.5, 1.5},
            [2] = {33.938, -12.327, 0.904, 0.5, 1.5},
            [3] = {31.783, -29.286, 1.001, 0.5, 1.5},
            [4] = {29.156, -28.209, 0.001, 0.5, 1.5},
            [5] = {12.136, -35.556, 0.903, 0.5, 1.5},
            [6] = {15.558, -36.189, 1.503, 0.5, 1.5},
            [7] = {14.233, -18.243, 0.001, 0.5, 1.5},
            [8] = {13.979, -20.295, 0.001, 0.5, 1.5},
            [9] = {11.309, -33.451, 1.504, 0.5, 1.5},
            [10] = {13.562, -32.037, 2.829, 0.5, 1.5},
            [11] = {-3.845, -34.529, 3.403, 0.5, 1.5},
            [12] = {-2.666, -32.918, 2.303, 0.5, 1.5},
            [13] = {-5.318, -22.303, 0.904, 0.5, 1.5},
            [14] = {-3.091, -18.093, 0.904, 0.5, 1.5},
            [15] = {-5.135, -20.192, 0.904, 0.5, 1.5},
            [16] = {-5.280, -32.926, 2.303, 0.5, 1.5},
        },
        ["prisoner"] = {
            ...
            [5] = {3.342, -5.180, 3.193, 0.5, 1.5},
            [6] = {-0.583, -6.166, -0.407, 0.5, 1.5},
            [7] = {-8.069, 1.383, -0.300, 0.5, 1.5},
            [8] = {-3.039, 3.011, -0.300, 0.5, 1.5},
            [9] = {2.813, 1.096, -0.406, 0.5, 1.5},
            [10] = {-7.190, -4.966, 5.593, 0.5, 1.5},
            [11] = {7.227, 4.987, 5.593, 0.5, 1.5},
            [12] = {-1.199, -4.641, 3.193, 0.5, 1.5},
            [13] = {-2.696, 4.629, 3.193, 0.5, 1.5},
            [14] = {-9.406, -2.364, 2.412, 0.5, 1.5},
            [15] = {4.025, -5.597, 1.393, 0.5, 1.5},
            [16] = {0.842, 0.016, -0.527, 0.5, 1.5},
        },
        ["wizard"] = {
            [1] = {6.001, 5.995, -2.631, 35, 10},
            [2] = {-5.982, -5.969, -2.640, 35, 10}
            [3] = {5.978, -6.026, -2.645, 35, 10}
            [4] = {-6.000, 5.985, -2.645, 35, 10}
            [5] = {-7.469, 11.140, -2.749, 35, 10},
            [6] = {-11.300, 7.512, -2.749, 35, 10},
            [7] = {11.090, -7.385, -2.749, 35, 10},
            [8] = {7.340, -11.118, -2.749, 35, 10},
            [9] = {-7.204, -10.863, -2.749, 35, 10},
            [10] = {-10.239, -7.827, -2.749, 35, 10},
            [11] = {-9.889, 7.180, -2.749, 35, 10},
            [12] = {-7.420, 9.807, -2.749, 35, 10},
            [13] = {1.033, -0.090, -2.299, 0.5, 1.5},
            [14] = {-5.262, 5.288, -4.499, 0.5, 1.5},
            [15] = {5.168, 5.178, -4.499, 0.5, 1.5},
            [16] = {5.250, -5.207, -4.499, 0.5, 1.5},
        },
        ["longest"] = {
            [1] = {13.403, -16.591, 0.001, 35, 10},
            [2] = {13.320, -15.239, 0.001, 35, 10},
            [3] = {11.505, -16.725, 0.001, 35, 10},
            [4] = {7.267, -15.361, 0.001, 35, 10},
            [5] = {-11.853, -21.532, -0.599, 0.5, 1.5},
            [6] = {-13.912, -21.747, -0.599, 0.5, 1.5},
            [7] = {-0.481, -15.320, 2.105, 0.5, 1.5},
            [8] = {-1.269, -13.700, 2.105, 0.5, 1.5},
            [9] = {-12.904, -20.676, -0.599, 0.5, 1.5},
            [10] = {-12.975, -11.158, 0.001, 0.5, 1.5},
            [11] = {-0.904, -14.556, 0.168, 0.5, 1.5},
            [12] = {4.983, -18.751, 2.057, 0.5, 1.5},
            [13] = {-0.673, -13.928, 0.001, 0.5, 1.5},
            [14] = {-8.193, -10.014, 2.057, 0.5, 1.5},
            [15] = {-17.104, -12.617, 0.001, 0.5, 1.5},
            [16] = {2.182, -10.833, 2.057, 0.5, 1.5},
        },
    }
end
