...
- This script was requested by Tucker998 (see link above).
- Someone beat me to it and fulfilled the request so I have decided to abandon my (unfinished) version of this mod.
        ...
        if not isCommand(voter, msg) then
            if (#msg == 1 and match(msg[1], "[0-9]")) then
                ...
                if (nominee ~= voter) then
                    if (nominee > 0 and nominee < 17) then
