    ...
    if player_alive(PlayerIndex) then
        ...
        if player_object ~= 0 then
            ...
            if current_weapon ~= 0 then
                ...
                for _, v in pairs(weapons[tonumber(PlayerIndex)]) do
                                    ...
                                    if ammo_pack_object ~= nil then
                                        ...
                                        if weapon_object ~= 0 then
                                            ...
                                            for k, v in pairs(weapons[tonumber(m)]) do
                                                if string.find(weapon_name, v[2]) then
                                                    for _, value in pairs(original_data) do
                                                        v[6] = original_data[k]
...
function OnObjectSpawn(PlayerIndex, MapID, ParentID)
    if (launcher_mode[PlayerIndex] == true) then
        for _, v in pairs(weapons[PlayerIndex]) do
