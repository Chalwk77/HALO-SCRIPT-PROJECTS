...
Description: This script will drop a special item from the EQUIPMENT_TABLE table at the victims death location.
...
function OnPlayerDeath(VictimIndex, KillerIndex)
    ...
    if victim and killer ~= KillerIndex then
        if (kills == 10) then -- Equal to or greater than 
