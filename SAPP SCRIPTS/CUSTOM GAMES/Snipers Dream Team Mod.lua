--[[
--=====================================================================================================--
Script Name: Snipers Dream Team Mod (bg), for SAPP (PC & CE)

This is an exact replica of the map-mod for the original {ØZ}-4 Snipers Dream Team Mod server.
...
local function SwapDependency(Address, ToTag, ToClass)
...
function OnStart()
    ...
    if (gt ~= "n/a" and map == "bloodgulch") then
