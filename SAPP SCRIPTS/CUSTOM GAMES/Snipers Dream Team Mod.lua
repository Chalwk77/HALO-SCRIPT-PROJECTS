        ...
        self.maps = {
            ...
            ["bloodgulch"] = {
                ...
                teleports = {
                    ...
                    { 101.224, -117.028, 14.884, 0.5, 104.910, -117.450, 15.110, 0.1 },
                    ...
                    { 84.920, -127.130, 0.540, 0.1, 69.700, -91.510, 25.060, 0.1 }, -- hidden teleport (rock in front of middle-cave)
                    { 117.100, -120.670, 14.83, 0.5, 125.026, -135.580, 13.593, 0.1 }
                },
