        ...
        self.maps = {
            ...
            ["bloodgulch"] = {
                ...
                teleports = {
                    ...
                    { 43.125, -78.434, -0.220, 0.5, 15.713, -102.762, 13.462, 0.3 },
                    { 43.112, -80.069, -0.253, 0.5, 68.123, -92.847, 2.167, 0.3 },
                    { 37.105, -80.069, -0.255, 0.5, 108.005, -109.328, 1.924, 0.3 },
                    { 37.080, -78.426, -0.238, 0.5, 79.924, -64.560, 4.669, 0.3 },
                    { 43.456, -77.197, 0.633, 0.5, 29.528, -52.746, 3.100, 0.3 },
                    { 74.304, -77.590, 6.552, 0.5, 76.001, -77.936, 11.425, 0.3 },
                    { 98.559, -158.558, -0.253, 0.5, 63.338, -169.305, 3.702, 0.3 },
                    { 98.541, -160.190, -0.255, 0.5, 120.801, -182.946, 6.766, 0.3 },
                    { 92.550, -158.581, -0.256, 0.5, 46.934, -151.024, 4.496, 0.3 },
                    { 92.538, -160.213, -0.215, 0.5, 112.550, -127.203, 1.905, 0.3 },
                    { 98.935, -157.626, 0.425, 0.5, 95.725, -91.968, 5.314, 280, 0.3 },
                    { 70.499, -62.119, 5.382, 0.5, 122.615, -123.520, 15.916, 0.3 },
                    { 63.693, -177.303, 5.606, 0.5, 19.040, -103.200, 19.040, 0.3 },
                    { 120.616, -185.624, 7.637, 0.5, 94.815, -114.354, 15.860, 0.3 },
                    { 94.351, -97.615, 5.184, 0.5, 92.792, -93.604, 9.501, 0.3 },
                    { 14.852, -99.241, 8.995, 0.5, 49.300, -153.59, 21.28, 0.3 },
                    { 43.258, -45.365, 20.901, 0.5, 82.065, -68.507, 18.152, 0.3 },
                    { 82.459, -73.877, 15.729, 0.5, 67.970, -86.299, 23.393, 0.3 },
                    { 77.289, -89.126, 22.765, 0.5, 94.772, -114.362, 15.820, 0.3 },
                    { 101.224, -117.028, 14.884, 0.5, 125.026, -135.580, 13.593, 0.3 },
                    { 131.785, -169.872, 15.951, 0.5, 127.812, -184.557, 16.420, 0.3 },
                    { 120.665, -188.766, 13.752, 0.5, 109.956, -188.522, 14.437, 0.3 },
                    { 97.476, -188.912, 15.718, 0.5, 53.653, -157.885, 21.753, 0.3 },
                    { 48.046, -153.087, 21.181, 0.5, 23.112, -59.428, 16.352, 0.3 },
                    { 118.263, -120.761, 17.192, 0.5, 40.194, -139.990, 2.733, 0.3 }
                },
