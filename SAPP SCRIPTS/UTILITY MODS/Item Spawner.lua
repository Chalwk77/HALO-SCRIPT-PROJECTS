...
local Mod = {
    ...
    items = {
        ...
        { "eqip", "powerups\\active camouflage", "a Camouflage", { "camo", "cam" } },
        { "eqip", "powerups\\health pack", "a Health Pack", { "health", "hp" } },
        { "eqip", "powerups\\over shield", "an Over Shield", { "overshield", "os", "oshield" } },
        { "eqip", "weapons\\frag grenade\\frag grenade", "a Frag Grenade", { "frag", "grenade", "fraggrenade" } },
        { "eqip", "weapons\\plasma grenade\\plasma grenade", "a Plasma Grenade", { "plasma", "plasmagrenade" } },

        -- Vehicles: (enter/spawn)
        { "vehi", "vehicles\\banshee\\banshee_mp", "a Banshee", { "banshee" } },
        { "vehi", "vehicles\\c gun turret\\c gun turret_mp", "a Turret", { "turret" } },
        { "vehi", "vehicles\\ghost\\ghost_mp", "a Ghost", { "ghost" } },
        { "vehi", "vehicles\\scorpion\\scorpion_mp", "a Tank", { "tank" } },
        { "vehi", "vehicles\\rwarthog\\rwarthog", "an R-Hog", { "rhog" } },
        { "vehi", "vehicles\\warthog\\mp_warthog", "a Warthog", { "hog" } },

        -- Weapons: (give/spawn)
        { "weap", "weapons\\assault rifle\\assault rifle", "an Assault Rifle", { "rifle" } },
        { "weap", "weapons\\ball\\ball", "a Skull", { "ball" } },
        { "weap", "weapons\\flag\\flag", "a Flag", { "flag" } },
        { "weap", "weapons\\flamethrower\\flamethrower", "a Flamethrower", { "flamethrower" } },
        { "weap", "weapons\\needler\\mp_needler", "a Needler", { "needler" } },
        { "weap", "weapons\\pistol\\pistol", "a Pistol", { "pistol" } },
        { "weap", "weapons\\plasma pistol\\plasma pistol", "a Plasma Pistol", { "ppistol" } },
        { "weap", "weapons\\plasma rifle\\plasma rifle", "a Plasma Rifle", { "prifle" } },
        { "weap", "weapons\\plasma_cannon\\plasma_cannon", "a Plasma Cannon", { "frg" } },
        { "weap", "weapons\\rocket launcher\\rocket launcher", "a Rocket Launcher", { "rocket", "rocketlauncher" } },
        ...
        { "proj", "vehicles\\ghost\\ghost bolt", "Ghost Bolt", { "ghostbolt" } },
        { "proj", "vehicles\\scorpion\\bullet", "Tank Bullet", { "tankbullet" } },
        { "proj", "vehicles\\scorpion\\tank shell", "Tank Bullet", { "tankshell" } },
        { "proj", "vehicles\\warthog\\bullet", "Warthog Bullet", { "hogbullet" } },
        { "proj", "weapons\\assault rifle\\bullet", "Assault Rifle Bullet", { "riflebullet" } },
        { "proj", "weapons\\flamethrower\\flame", "Flames", { "flame" } },
        { "proj", "weapons\\needler\\mp_needle", "Needler Needle", { "needle" } },
        { "proj", "weapons\\pistol\\bullet", "Pistol Bullet", { "pistolbullet" } },
        { "proj", "weapons\\plasma pistol\\bolt", "Plasma Pistol Bolt", { "ppistolbolt" } },
        { "proj", "weapons\\plasma rifle\\bolt", "Plasma Rifle Bolt", { "priflebolt" } },
        { "proj", "weapons\\plasma rifle\\charged bolt", "Plasma Rifle Charged Bolt", { "priflecbolt" } },
        { "proj", "weapons\\rocket launcher\\rocket", "Rocket", { "rocketproj" } },
        { "proj", "weapons\\shotgun\\pellet", "Shotgun Pellet", { "shottyshot" } },
        { "proj", "weapons\\sniper rifle\\sniper bullet", "Sniper Bullet", { "snipershot" } },
        { "proj", "weapons\\plasma_cannon\\plasma_cannon", "Plasma Cannon Shot", { "fuelrodshot" } },
    },
