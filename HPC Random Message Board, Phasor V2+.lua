--[[    
------------------------------------
Description: HPC Random Message Board, Phasor V2+
...
function OnGameEnd(mode)
	if mode == 1 then
		if FirstTimer then FirstTimer = nil 
		end
		if SecondTimer then SecondTimer = nil 
		end
		if ThirdTimer then ThirdTimer = nil 
		end
		if ForthTimer then ForthTimer = nil 
		end
		if FifthTimer then FifthTimer = nil 
		end
    end
end
